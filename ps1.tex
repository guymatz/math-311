...
Let $y \in (B_0 \cup B_1)$, wlog $y \in B_0$.  By definition, $f^{-1}(b) \in f^*(B_0) \subseteq f^*(B_0) \cup f^*(B_1)$. 
\\
...
\\
Now suppose $y \in f^*(B_0) \cup f^*(B_1)$, wlog $y \in f^*(B_0)$.  By definition, $y \in f^*(B_0 \cup B_1)$.  We can conclude $f^*(B_0) \cup f^*(B_1) \subseteq f^*(B_0 \cup B_1)$
