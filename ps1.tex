...
Let $x \in X_1$.  We want to show that 
$$(g \circ f)^{-1}(x) = (f^{-1} \circ g^{-1})(x)$$
Since $f(x_1) = x_2 \in X_2$, and $g(x_2) = x_3 \in X_3$, we have that $f^{-1}(x_2) = x_1 \in X_1$, and $g^{-1}(x_3) = x_2 \in X_2$.  Unravelling the composition we have
\begin{align*}
g^{-1}(f^{-1}(x_2)) &= f^{-1}((g^{-1})(x_3))\\
g^{-1}(x_1) &= f^{-1}(x_2)\\
x_2 &= x_1 ???
\end{align*}
\end{enumerate}
